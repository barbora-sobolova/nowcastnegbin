...
transformed parameters {
  ...
  array[m] real nb_size_times_pis = multiply_array_by_scalar(nb_size, lambda_times_pis);
}
...
generated quantities {
  ...
  array[d*n] real complete_nb_size_times_pis = multiply_array_by_scalar(nb_size, complete_lambdas_times_pis);
